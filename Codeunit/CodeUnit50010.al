Codeunit 50010 "Seminar Management"
{
    ...
    begin
        ...
        if (PSeminarRegHeader.Status <> PSeminarRegHeader.Status::Finished) then begin
            Error(SeminarRegistrationStatusError);
        end;
        ...
        if SeminarRegLine.FindSet() then begin
            ...
            repeat
                ...
                if not SalesHeader.FindFirst() then begin
                    ...
                    SalesHeader.Validate("Sell-to Customer No.", SeminarRegLine."Bill-to Customer No."); //bill
                ...
                SalesLine.Description := StrSubstNo(DescriptionTemplateTxt, PSeminarRegHeader."Seminar Name", SeminarRegLine."Participant Name"); //TODO: wprowadź dwa pola wymagane w opisie wiersza faktury );
                SalesLine.Insert();
    ...
    var
        SeminarRegistrationStatusError: label 'You can create invoice only for finished seminar.';
